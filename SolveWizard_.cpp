...
void SolveWizard::ActionResolveEnds(CCObject *cell)
{
    this->resolvingCount--;
...
void SolveWizard::ResolveWithAnim(Cell *cell, const float animDuration)
{
	...
	//auto actionResolveEnds = CCCallFunc::create(CCCallFuncO::create(SolveWizard::ActionResolveEnds, this, (CCObject *)cell));
	CCCallFuncO* actionResolveEnds = CCCallFuncO::create(this, SolveWizard::ActionResolveEnds, (CCObject *)cell);
